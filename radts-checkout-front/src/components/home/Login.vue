<template>
  <div class="login-container">
    <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left" label-width="0px"
      ...
      <h3 class="title">RADTS-CHECKOUT</h3>
      ...
      <el-form-item prop="password">
        ...
        <el-input name="password" :type="pwdType" @keyup.enter.native="handleLogin" v-model="loginForm.password" autoComplete="on" placeholder="password"></el-input>
          <span class="show-pwd" @click="showPwd">
            <i class="iconfont"  v-bind:class="[isNotShowPwd, isShowPwd]"></i>
            <!-- <i class="iconfont"  v-bind:class="{'icon-buxianshimima': isNotShowPwd,'icon-faxianxianshimima': isShowPwd'}"></i> -->
          </span>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      loading: false,
      pwdType: 'password',
      isNotShowPwd: 'icon-buxianshimima',
      isShowPwd: ''
    }
  },
  methods: {
    showPwd () {
      if (this.pwdType === 'password') {
        this.pwdType = ''
        this.isNotShowPwd = ''
        this.isShowPwd = 'icon-faxianxianshimima'
      } else {
        this.pwdType = 'password'
        this.isNotShowPwd = 'icon-buxianshimima'
        this.isShowPwd = ''
      }
    },
    handleLogin () {
